...
exports.interviewBank = exports.codingBank = exports.aptitudeBank = void 0;
exports.shuffleArray = shuffleArray;
exports.getRandomQuestions = getRandomQuestions;
// ─────────────────────────────────────────────────────────
// APTITUDE QUESTIONS BANK (100+ questions)
// ─────────────────────────────────────────────────────────
exports.aptitudeBank = [
    // TIME & DISTANCE
...
function getRandomQuestions(bank, count, topicFilter, difficultyFilter) {
    let filtered = bank;
    if (topicFilter) {
        filtered = filtered.filter((q) => q.topic?.toLowerCase().includes(topicFilter.toLowerCase()) ||
