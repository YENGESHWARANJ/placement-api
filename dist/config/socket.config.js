...
exports.onlineUsers = exports.broadcastGlobalEvent = exports.sendNotification = exports.getIO = exports.initSocket = void 0;
...
const broadcastGlobalEvent = (event, data) => {
    if (io) {
        io.emit(event, data);
    }
};
