...
const resource_model_1 = __importDefault(require("../modules/resources/resource.model"));
...
const seedResources = async () => {
    try {
        ...
        await resource_model_1.default.deleteMany({});
        console.log("🗑️  Cleared existing resources");
        // Insert sample resources
        const inserted = await resource_model_1.default.insertMany(sampleResources);
